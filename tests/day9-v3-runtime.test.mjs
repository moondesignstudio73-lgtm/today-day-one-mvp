...
for(const id of ["shopping9_together_short","gift9_secret_after_looking","fit9_confident_recommendation","fit9_push_special_day","green9_decide_buy_now","scarf9_buy_secret","scarf9_push_wear_once","player9_try_top","checkout9_offer_green_gift","memory9_words_only","dinner9_set_time_together"])applyDay9V3Choice(low,id);
...
for(const id of ["shopping9_each_then_meet","gift9_observe_before_offer","fit9_say_my_preference","fit9_ask_wearing_comfort","green9_like_her_smile","scarf9_buy_secret","scarf9_ask_exchange","player9_rest_bench","checkout9_no_new_purchase","memory9_keep_private_fitting","dinner9_defer_and_ask_again"])applyDay9V3Choice(rest,id);
