...
import { getEligibleEvents, getEventDiagnostics, getEventProbability, getRuntimeEventDefinitions, MAX_EVENTS_PER_DAY, meetsConditions, rollEvent, rollRuntimeEvent, triggerEvent } from "../src/event-manager.mjs";
...
assert.match(gameSource,/work:\{title:"야간 업무",icon:"💼",effects:\{money:50000,work:1,stress:7,fatigue:5,energy:-5\}\}/);
