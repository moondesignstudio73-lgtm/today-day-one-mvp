...
test('runtime rejects legacy hand-art filenames and quarantines every shipped fallback URL', () => {
  ...
  for(const file of ['yuri-menu-wait-water-v8.png','food-sharing-v3.png','haeun-tasting-v3.png','own-meals-v3.png','table-space-v2.png','vegetable-bite-v2.png','haeun-menu-slide-v2.png','menu-open-v2.png','menu-closed-v2.png','washing-cup-night-v2.png','morning-alarm-off-v2.png','wallet-open-v2.png','wallet-closed-v2.png','solo-bag-seat-move-v2.png']) {
    assert.ok(existsSync(new URL(`../assets/events/day18-v4/${file}`,import.meta.url)),file);
  }
  for(const [legacy,approved] of [
    ['yuri-menu-wait-water-v1.png','yuri-menu-wait-water-v8.png'],
    ['yuri-menu-wait-water-v2.png','yuri-menu-wait-water-v8.png'],
    ['yuri-menu-wait-water-v3.png','yuri-menu-wait-water-v8.png'],
    ['yuri-menu-wait-water-v4.png','yuri-menu-wait-water-v8.png'],
    ['yuri-menu-wait-water-v5.png','yuri-menu-wait-water-v8.png'],
    ['yuri-menu-wait-water-v6.png','yuri-menu-wait-water-v8.png'],
    ['yuri-menu-wait-water-v7.png','yuri-menu-wait-water-v8.png'],
...
test('the protagonist drinks water only after the Yuri menu counting-unit joke', () => {
  for(const context of [{},{callScheduling:true},{callScheduling:true,separateDinnerScheduling:true}])for(const partner of ['YURI','HAEUN'])for(const menu of ['menu_each','menu_share','menu_wait']) {
    ...
    const before=JSON.stringify(s),steps=getDay18V4PlayableSegment(s.storyFlags.day18V4),at=steps.findIndex(x=>x.source==='assets/events/day18-v4/yuri-menu-wait-water-v8.png');
