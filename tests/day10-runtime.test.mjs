...
state.storyFlags={day10ThreeHourWorkRhythmPending:true};state.scenario.introducedNpcIds.push("female-coworker","team-lead","office-best-male");
...
assert.deepEqual(applyLockedDay10ChoiceState(state,"work10_lunch_current_roles"),{stage:2});assert.equal(getLockedDay10ResumePresentation(state).backgroundId,"cafe-rain-evening");
