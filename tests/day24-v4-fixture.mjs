...
export function completedDay23ForDay24(route='SEOUL_DAY',options={}){
  ...
  while(state.storyFlags.day23V4.phase!=='ending'){
    assert.ok(guard++<40,'DAY23 fixture guard');const chapter=state.storyFlags.day23V4;
    ...
    assert.ok(selected,`DAY23 fixture ${chapter.phase}`);applyDay23V4Choice(state,selected.id);
  }
