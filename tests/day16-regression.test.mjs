...
const gameSource=readFileSync(new URL("../game.js",import.meta.url),"utf8"),html=readFileSync(new URL("../index.html",import.meta.url),"utf8");assert.match(gameSource,/day16-campaign-runtime\.mjs\?v=2/);assert.match(html,/game\.js\?v=224/);
