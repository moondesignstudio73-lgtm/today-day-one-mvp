...
for(const marker of ["china-diner","small-cafe","live-house","007_china-diner.png","004_small-cafe.png","027_live-house.png","NEW CG REQUIRED","NEW PHONE POV REQUIRED","NEW CLOTHING PHOTO POV REQUIRED","desktop center-80/mobile center-60","DAY 9는 시작하지 않는다"])assert.ok(audit.includes(marker),marker);
