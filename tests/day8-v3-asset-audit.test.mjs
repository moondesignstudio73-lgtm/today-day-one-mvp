...
for(const marker of ["china-diner","small-cafe","live-house","007_china-diner.png","004_small-cafe.png","027_live-house.png","cg-day8-v3-overfilled-water-glass-v1.png","READY — 사진 요청 경로 한정","READY — 실제 이름은 UI 오버레이","LIVE HOUSE/CAFE READY","READY — 휴식 경계 다음 아침에는 미노출","6/6 제작","desktop center-80/mobile center-60","DAY 9는 시작하지 않는다"])assert.ok(audit.includes(marker),marker);
...
assert.equal(audit.includes("기존 DAY 8 세이지 외출 의상"),true);
