...
for(const marker of ["china-diner","small-cafe","live-house","007_china-diner.png","004_small-cafe.png","027_live-house.png","cg-day8-v3-overfilled-water-glass-v1.png","READY — 사진 요청 경로 한정","READY — 실제 이름은 UI 오버레이","CAFE ACTION CG REQUIRED","NEW CLOTHING PHOTO POV REQUIRED","desktop center-80/mobile center-60","DAY 9는 시작하지 않는다"])assert.ok(audit.includes(marker),marker);
