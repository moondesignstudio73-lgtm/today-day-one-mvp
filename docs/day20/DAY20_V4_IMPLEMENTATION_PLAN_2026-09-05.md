...
4. opening / domestic / intimacy / ending playable 모듈과 game bridge를 구현한다. **진행 중:** playable SCENE01~24와 독립 game bridge 구현 완료, `game.js` 진입/입력 연결 미구현. legacy DAY20 저장은 자동 변환하지 않는다.
...
- runtime integration/browser QA: NOT STARTED.
- DAY20 COMPLETE: **아님**.
- 다음 시작점: `game.js`의 DAY20 진입·선택·접촉/숙박 응답·완료/스킵·재개를 V4 bridge에 연결하고 Story/Free 배타성을 검증한다.
