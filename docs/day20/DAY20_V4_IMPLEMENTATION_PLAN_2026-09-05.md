...
4. opening / domestic / intimacy / ending playable 모듈과 game bridge를 구현한다. **진행 중:** playable SCENE01~24 구현 완료, game bridge 미구현. legacy DAY20 저장은 자동 변환하지 않는다.
...
- DAY20 COMPLETE: **아님**.
- 다음 시작점: 네 playable 모듈과 solo 모듈을 game bridge에 연결하고 저장/로드·완료 history·Story/Free 배타성을 검증한다.
