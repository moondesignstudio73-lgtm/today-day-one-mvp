...
4. opening / domestic / intimacy / ending playable 모듈과 game bridge를 구현한다. **진행 중:** opening SCENE01~04 및 solo 생활 대체→SCENE23 진입 구현. legacy DAY20 저장은 자동 변환하지 않는다.
...
- DAY20 COMPLETE: **아님**.
- 다음 시작점: domestic SCENE05~11과 solo C5 반응~C8를 구현한 뒤 opening과 함께 game bridge에 연결한다.
