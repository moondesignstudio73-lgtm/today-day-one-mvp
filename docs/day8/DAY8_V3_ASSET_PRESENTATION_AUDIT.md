...
|---|---|---|---|
| S05 | 넘치게 따른 물컵과 둘의 손, 선택 음식 | 배경만으로 행동이 보이지 않음 | NEW CG REQUIRED |
| S06 | 이사 상자 앞 과거 사진 한 장 | DAY 4 볼링 사진은 의미가 다름 | NEW PHONE POV REQUIRED, 사진 요청 경로 한정 |
| S12 | 별도 공개 영상의 끝 크레딧에서 지훈 이름 확인 | 사적 작업과 혼동 위험 | NEW PHONE POV REQUIRED, 실제 텍스트는 UI 오버레이 |
| S15 | 공연 엇박수 / 카페 냅킨 그림 / 집 공개 영상 | 지도 배경만으로 핵심 행동이 약함 | 공연·카페 2종 ACTION CG REQUIRED; 귀가는 S12 CG 재사용 |
| S24 | 하은이 이미 가진 다른 색 옷 두 벌 사진 | 구 세이지 의상은 ‘오늘 외출’로 오해됨 | NEW CLOTHING PHOTO POV REQUIRED |

신규 6종은 모두 1672×941 이상 16:9, 텍스트/브랜드 없는 원본으로 제작한다. 휴대전화의 크레딧 이름·메시지는 HTML UI가 담당한다. 지훈 얼굴·손·컵·휴대전화·냅킨·옷 두 벌은 중앙 mobile center-60 안에 남겨야 한다.
