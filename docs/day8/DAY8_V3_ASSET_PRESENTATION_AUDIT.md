...
| S15 | 공연 엇박수 / 카페 냅킨 그림 / 집 공개 영상 | 공연·카페 CG 제작·육안 QA | LIVE HOUSE/CAFE READY; 귀가는 S12 CG 재사용 |
| S24 | 하은이 이미 가진 비슷한 계열 옷 두 벌 사진 | 신규 1672×941 휴대전화 POV 제작·육안 QA | READY — 휴식 경계 다음 아침에는 미노출 |

신규 6종은 모두 1672×941 16:9 RGB, 텍스트/브랜드 없는 원본으로 제작했다. 휴대전화의 크레딧 이름·메시지는 HTML UI가 담당한다. 지훈 얼굴·손·컵·휴대전화·냅킨·옷 두 벌은 중앙 mobile center-60 안에 남는다. S05·S06·S12·S15 공연/카페·S24 6/6 제작·원본 육안 QA·조건부 자산 연결 PASS다.
