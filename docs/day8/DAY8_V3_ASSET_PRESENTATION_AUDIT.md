...
신규 6종은 모두 1672×941 이상 16:9, 텍스트/브랜드 없는 원본으로 제작한다. 휴대전화의 크레딧 이름·메시지는 HTML UI가 담당한다. 지훈 얼굴·손·컵·휴대전화·냅킨·옷 두 벌은 중앙 mobile center-60 안에 남겨야 한다. 현재 S05·S06 2/6 제작·원본 육안 QA·조건부 자산 연결 PASS이며 나머지 4종은 미완료다.
