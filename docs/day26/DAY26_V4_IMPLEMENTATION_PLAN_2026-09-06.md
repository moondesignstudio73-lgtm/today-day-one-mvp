...
SCENE21 대체 C2~8 혼자 생활, SCENE22/C13 조건부 하은 밤 연락, SCENE23~24/C14 ending과 DAY27 hook playable을 구현한다. 하은이 연락을 쉬는 상태에서는 SCENE22를 만들지 않고, 정정 대상과 다음 대화 시간을 실제 이력으로 넘긴다. 이 관문 전까지 DAY26는 **PARTIAL**이다.
