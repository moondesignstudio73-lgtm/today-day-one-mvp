...
- 정정(2026-09-04): DAY 18 완료 판정 철회. 현재 런타임은 원본 「말하지 않은 저녁」이 아닌 집 안전 점검 8장면이다.
- 원본 전체 구현·플레이 QA를 모두 통과한 마지막 회차는 재감사 중이며 아직 확정하지 않는다.
- 다음 재구현 대상: **DAY 18 — 말하지 않은 저녁**. DAY 15~17의 입력 이력과 원본도 함께 대조한다.
