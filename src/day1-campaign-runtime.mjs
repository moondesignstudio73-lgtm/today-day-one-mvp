...
function questionReaction(choiceId){
  const explain=npc("npcFront","doctor-explain-open-hands-2d-v2.png");
  if(choiceId==="family_question_first")return [explain,d("나","가족은요? 지금 연락할 수 있는 사람이 있습니까?"),d("담당 의사","사고 당시 부모님도 함께 계셨고 두 분은 사망하셨습니다. 지금 더 자세한 설명을 원하시면 한 번에 하나씩 확인하겠습니다."),d("나","먼저 그 사실까지만 듣겠습니다.")];
  if(choiceId==="accident_interest")return [explain,d("나","사고 기록은 어디까지 확인됐습니까?"),d("담당 의사","교통사고였다는 사실과 부상·치료 기록은 병원에서 확인할 수 있습니다. 사고 경위의 세부사항은 의료 기록과 별개입니다."),d("나","지금 모르는 것과 나중에 확인할 수 있는 것을 나눠 주십시오."),d("담당 의사","좋습니다. 오늘은 치료 기록, 이후에는 정식 사고 기록을 확인하는 순서가 안전합니다.")];
  return [explain,d("나","제가 다시 혼자 움직이려면 무엇부터 해야 합니까?"),d("담당 의사","오늘은 앉는 자세와 삼킴 상태부터 확인합니다. 기립과 보행은 재활 평가 뒤에 시작합니다."),d("나","중단해야 할 증상도 알려 주십시오."),d("담당 의사","어지럼, 호흡 곤란, 새 통증이 있으면 즉시 멈춥니다. 혼자 시험하지 않는 것이 첫 번째 계획입니다."),d("하은","그 계획은 내가 먼저 지킬게.","calm-attentive")];
}
...
const SEGMENT_0=[
  ...
  n("천장. 수액. 기계음. 병원인가."),n("고개를 돌리자 침대 옆 의자에 보라색 머리의 여자가 앉아 있었다. 손에는 꺼진 휴대폰이 들려 있었다.",{backgroundId:BG_BEDSIDE}),
  sprite("poses/haeun-pose-seated-dozing-2d.png","resting-tired",{positionPreset:"left",depth:"normal"}),sfx("SFX_PHONE_SOFT_DROP"),cg(`${CG}cg-day1-first-eye-contact-v2.png`,2600),
...
const SEGMENT_1_HEAD=[
  ...
  tr("SCENE 02 · 이름과 관계"),d("나","여긴 병원이지?"),d("하은","응. 병원 입원실이야."),d("나","나는 왜 여기 있어?"),d("하은","사고가 있었어. 자세한 건 의사 선생님이 기록 보면서 설명하는 게 정확해."),n("모르는 건지, 말을 고르는 건지는 아직 판단할 수 없다."),d("나","내 이름은?"),d("하은","[플레이어 이름]."),n("이름을 속으로 되뇌었지만 익숙하다는 느낌조차 없었다."),d("나","우리 관계는?"),sprite("poses/haeun-pose-seated-no-contact-2d.png","calm-attentive",{positionPreset:"left",depth:"normal"}),d("하은","나는 스물세 살, 이하은. 그리고…… 네 여자친구야."),d("나","확인할 수 있는 게 있어?"),d("하은","사진도 있고 연락 기록도 있어. 그런데 지금 네 얼굴 앞에 들이밀지는 않을게. 네 휴대폰이 돌아오면 네가 직접 확인해."),d("나","내가 의심해서 기분 나쁘지는 않고?"),d("하은","조금은 나쁘지. 나는 오래 기다렸는데 넌 처음 보는 사람이니까."),d("하은","그래도 확인하는 게 맞아. 나라도 그럴 거야.","warm-playful"),sfx("SFX_FOOTSTEP_APPROACH"),
  tr("SCENE 03 · 1년"),sprite("poses/haeun-pose-standing-bedside-restraint-2d.png","calm-attentive",{positionPreset:"right",depth:"background"}),npc("npcFront","doctor-bedside-assessment-2d-v2.png"),npc("npcRear","nurse-vitals-check-2d-v2.png"),sfx("SFX_DOOR_OPEN"),d("담당 의사","[플레이어 이름] 환자분, 제 말 들리십니까? 담당 의사입니다. 먼저 현재 상태부터 확인하겠습니다."),sfx("SFX_MEDICAL_LIGHT"),n("빛을 따라 눈동자를 움직이고 양손을 번갈아 쥐었다 폈다. 간호사는 활력징후를 확인했다."),npc("npcFront","doctor-record-and-explain-2d-v2.png"),npc("npcRear",""),d("담당 의사","여기가 어디인지는 아십니까?"),d("나","병원이라는 건 압니다. 병원 이름은 방금 들었습니다."),d("담당 의사","본인 이름은요?"),d("나","저분에게 들었습니다. 스스로 기억난 건 아닙니다."),d("담당 의사","좋습니다. 들은 정보와 떠오른 기억을 구분해서 말씀해 주세요. 오늘 날짜나 사고 전 일은 기억나십니까?"),d("나","아니요. 제 이름도, 가족도, 저 사람도 기억나지 않습니다."),d("담당 의사","현재 대화를 이해하고 판단하는 기능은 유지되어 있습니다. 다만 과거 기억에는 큰 공백이 있는 것으로 보입니다. 정확한 범위는 추가 검사가 필요합니다."),d("나","기억상실입니까?"),d("담당 의사","현재로서는 그 가능성이 높습니다. 회복 시기와 범위는 지금 단정할 수 없습니다."),d("나","얼마나 오래 누워 있었습니까?"),bgm("S03_B03_ONE_YEAR"),d("담당 의사","사고 이후 약 1년입니다."),n("기계음은 같은 간격으로 울렸다. 이불 위의 손은 뼈마디가 도드라져 보였다."),d("나","1년을 잊은 게 아니라, 1년 동안 의식이 없었던 겁니까?"),d("담당 의사","그렇습니다. 사고 전 기억의 손상과 혼수 기간은 구분해서 봐야 합니다."),npc("npcRear","nurse-safety-guidance-2d-v2.png"),d("간호사","지금은 혼자 일어나지 마세요. 삼킴 상태를 확인하기 전에는 물도 바로 드시면 안 됩니다."),
...
export function getLockedDay1Segment(state,segment=0){if(segment===0)return structuredClone(SEGMENT_0);if(segment===1)return [...contactReaction(state.storyFlags?.day1ContactStrategy),...structuredClone(SEGMENT_1_HEAD)];const sequence=endingSegment(state);const endIndex=sequence.findIndex(step=>step.type==="sceneEnd");sequence.splice(endIndex<0?sequence.length:endIndex,0,{type:"freeAction",id:"day1-hospital-evening",phase:"evening",location:"hospital",maxActions:1});return sequence;}
