...
export const TEMPTATION_CHOICES = {
  ...
  secret:{ label:"비밀 만남을 받아들인다", npcInterest:12, npcTrust:8, partnerTrust:-20, conflict:12 }
};
...
export function resolveTemptation(state, npcId, choiceId) {
  ...
  const record = { day:state.day, npcId, choiceId, partnerTrust:choice.partnerTrust, conflict:choice.conflict };
