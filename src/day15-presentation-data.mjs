...
export function validateDay15PresentationData(scenes=DAY15_PRESENTATION_SCENES){
  ...
  return values.length===8&&values.every(scene=>{
    ...
    return scene.assetStatus==="ready"&&backgrounds.every(id=>AUDITED_BACKGROUNDS.has(id))&&
