...
export const ACTIONS = {
  morning: [
    ...
    { id:"morning-gym", icon:"🏃", title:"아침 운동", desc:"가볍게 뛰며 몸과 자신감을 관리한다.", costLabel:"시간 1", timeCost:1, requirements:[{ stat:"energy", operator:">=", value:12, message:"체력 12 이상 필요" }], effects:{ health:8, charm:5, energy:-7, stress:-4 }, tag:"자기관리" },
