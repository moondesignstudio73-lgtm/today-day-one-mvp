...
export const ACTIONS = {
  ...
  day: [
    ...
    { id:"lunch-date", icon:"🍝", title:"연인과 점심", desc:"잠깐이라도 얼굴을 보며 함께 식사한다.", costLabel:"₩38,000", timeCost:1, requirements:[{ stat:"money", operator:">=", value:38000, message:"자산 ₩38,000 이상 필요" }], effects:{ money:-38000, affection:12, trust:8, stress:-7 }, tag:"데이트" },
...
const PLAYER_JOB_ACTIONS = [
  ...
  ["day",{id:"job-dealer-buy-car",icon:"🚙",title:"딜러가로 자동차 매입하기",desc:"업계 경매와 인맥을 이용해 전기 세단을 40% 저렴하게 산다.",costLabel:"₩5,340,000",timeCost:1,jobIds:["used-car-dealer"],itemId:"solstice-ev",itemOwner:"player",requirements:[{stat:"money",operator:">=",value:5340000,message:"자산 ₩5,340,000 이상 필요"}],effects:{money:-5340000,social:5,confidence:6},tag:"딜러 특전"}],
  ["evening",{id:"job-dealer-gift-car",icon:"🎁",title:"여자친구에게 자동차 선물하기",desc:"딜러 네트워크로 전기 세단을 30% 할인해 선물한다.",costLabel:"₩6,230,000",timeCost:1,jobIds:["used-car-dealer"],itemId:"solstice-ev",itemOwner:"gift",autoGift:true,requirements:[{stat:"money",operator:">=",value:6230000,message:"자산 ₩6,230,000 이상 필요"}],effects:{money:-6230000,affection:80,trust:35},tag:"딜러 특전"}],
