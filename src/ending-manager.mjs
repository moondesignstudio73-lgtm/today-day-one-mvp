...
export const ENDING_DEFINITIONS = [
  ...
  { id:"wealthy-marriage", title:"경제적으로 성공한 결혼", description:"사랑과 경제적 안정을 함께 쌓은 두 사람은 든든한 미래를 약속했다.", matches:state => getAssetSummary(state).netWorth >= 2000000 && state.affection >= 650 && state.trust >= 600 },
  ...
  { id:"love-marriage", title:"사랑으로 결혼", description:"완벽하지 않아도 서로의 편이 되어 온 시간은 한 번뿐인 약속이 되었다.", matches:state => state.affection >= 760 && state.trust >= 720 },
