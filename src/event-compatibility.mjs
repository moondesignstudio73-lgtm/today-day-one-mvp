...
const DAY9_HOME_SEPARATE_FEEDBACK=Object.freeze({
  ...
  cooldown:30,maxTriggerCount:1,probability:.35,priority:270,baseWeight:100,tensionLevel:"low",effects:{work:1},storyFlag:"context-day9-home-separate-feedback:COMPLETED",forbiddenFlags:["context-day9-home-separate-feedback:COMPLETED","day9V3Complete"],repeatable:false,
  image:{intro:"assets/backgrounds/day2/day2-home-entry-living-afternoon-v1.png",result:"assets/backgrounds/day2/day2-home-entry-living-afternoon-v1.png",status:"ready"},presentation:{backgroundId:"day2-home-entry",characterId:"girlfriend",expressionId:"calm-attentive",poseId:"phone"},
...
const DAY25_HOME_WEDDING_PACKAGE_RESTORE=Object.freeze({
  id:"context-day25-home-wedding-package-restore",title:"과거 웨딩 패키지를 복원할까요?",category:"romance",categoryLabel:"스토리 공용 이벤트",hook:"웨딩 업체가 사고 전 계약의 장소·촬영·초대장·공개 옵션을 하나의 패키지로 복원하면 할인과 예약금을 유지할 수 있다고 알렸다.",message:"오늘 정한 것은 현재 예식 범위이며 과거 묶음 계약이나 개인정보 공개를 자동 승인한 것이 아니다.",question:"과거 웨딩 패키지 복원 제안을 어떻게 처리할까?",allowedLocations:["home"],allowedPhases:["evening"],dayRange:[25,25],heroineIds:["haeun"],relationshipStates:["DISTANT","RECOVERING","STABLE","HONEYMOON","PASSIONATE"],requiredFeatures:["phone","finance","current-wedding-form-scope","wedding-budget-and-contract-boundary","wedding-guest-and-disclosure-consent"],requiredStoryFlags:["day25RuntimeComplete","day25CurrentWeddingScopeCompleted"],cooldown:30,maxTriggerCount:1,probability:.35,priority:430,baseWeight:100,tensionLevel:"low",effects:{trust:1},storyFlag:"context-day25-home-wedding-package-restore:COMPLETED",forbiddenFlags:["context-day25-home-wedding-package-restore:COMPLETED"],repeatable:false,
  image:{intro:"assets/backgrounds/morning-studio-2d.png",result:"assets/backgrounds/morning-studio-2d.png",status:"ready"},presentation:{backgroundId:"home-morning",characterId:"girlfriend",expressionId:"calm",poseId:"phone"},scenes:[{id:"context-day25-home-wedding-package-restore-scene",title:"과거 웨딩 패키지를 복원할까요?",backgroundId:"home-morning",characterIds:["girlfriend"],expression:"calm",pose:"phone",animation:"idle-breathe",outfit:"default",itemIds:[],bgmId:"daily",sfxId:"scene",transition:"fade",lighting:"evening",timeOfDay:"evening",weather:"clear",dialogueTurns:[{type:"narration",speaker:"내레이션",text:"업체 메시지는 예약금 보전이라는 문구 아래 장소, 촬영, 초대 명단과 공개 옵션을 한 번에 다시 켜려 했다."},{type:"dialogue",speaker:"하은",text:"오늘 합의한 예산과 초대 범위를 이 패키지가 넘어가. 할인 때문에 묶어서 승인할 필요는 없어.",expressionId:"calm"},{type:"dialogue",speaker:"나",text:"과거 패키지는 복원하지 않고 필요한 항목만 새 견적과 동의로 요청할게."},{type:"dialogue",speaker:"하은",text:"우리 정보도 업체나 초대 대상에게 자동으로 공유되지 않게 확인하자.",expressionId:"smile"},{type:"narration",speaker:"내레이션",text:"과거 계약은 현재 예식의 기본값이 되지 않았고, 각 항목은 실행 직전 다시 선택해야 하는 상태로 남았다."}]}],choices:[{id:"reject-old-wedding-package",label:"과거 패키지·명단·공개 옵션 복원을 모두 거절한다",preferenceTags:["BOUNDARY","PRACTICAL"],effects:{trust:5,confidence:5,stress:-3},response:"과거 웨딩 패키지와 초대 명단, 공개 옵션 복원을 거절했다.",flag:"context-day25-home-wedding-package-restore:REJECTED",memory:"DAY 25 과거 웨딩 패키지 자동 복원을 거절했다.",futureEventWeights:{romance:1.2}},{id:"request-itemized-current-quote",label:"현재 범위 안의 항목만 새 견적과 별도 승인으로 요청한다",preferenceTags:["LOGICAL","PLANNED"],effects:{trust:4,confidence:5,money:1,stress:-2},response:"현재 합의 범위 안의 항목만 새 견적과 별도 승인으로 요청했다.",flag:"context-day25-home-wedding-package-restore:ITEMIZED",memory:"DAY 25 예식 항목을 현재 범위의 개별 견적으로 다시 요청했다.",futureEventWeights:{romance:1.15}}],futureEventWeights:{romance:1.2},requiredMemories:[],requiredEvents:[],npcRequirements:[],kind:"story",sourceMode:"free-romance"
});
const DAY26_HOME_LEGAL_BUNDLE_IMPORT=Object.freeze({
  id:"context-day26-home-legal-bundle-import",title:"과거 공동 서류를 불러올까요?",category:"finance",categoryLabel:"스토리 공용 이벤트",hook:"혼인 준비 포털이 과거 공동 서류를 불러오면 주소 변경·재산 정보 조회·전자서명 위임을 한 번에 설정할 수 있다고 제안했다.",message:"오늘 준비한 것은 최소 서류와 개별 권리이며 과거 문서나 묶음 권한을 현재 제출 동의로 볼 수 없다.",question:"과거 공동 서류와 묶음 권한 불러오기를 어떻게 처리할까?",allowedLocations:["home"],allowedPhases:["evening"],dayRange:[26,26],heroineIds:["haeun"],relationshipStates:["DISTANT","RECOVERING","STABLE","HONEYMOON","PASSIONATE"],requiredFeatures:["phone","finance","current-legal-document-minimum","marriage-legal-effects-boundary","individual-signature-and-stop-right"],requiredStoryFlags:["day26RuntimeComplete","day26CurrentLegalPreparationCompleted"],cooldown:30,maxTriggerCount:1,probability:.35,priority:440,baseWeight:100,tensionLevel:"low",effects:{confidence:1},storyFlag:"context-day26-home-legal-bundle-import:COMPLETED",forbiddenFlags:["context-day26-home-legal-bundle-import:COMPLETED"],repeatable:false,
  image:{intro:"assets/backgrounds/morning-studio-2d.png",result:"assets/backgrounds/morning-studio-2d.png",status:"ready"},presentation:{backgroundId:"home-morning",characterId:"girlfriend",expressionId:"calm",poseId:"phone"},scenes:[{id:"context-day26-home-legal-bundle-import-scene",title:"과거 공동 서류를 불러올까요?",backgroundId:"home-morning",characterIds:["girlfriend"],expression:"calm",pose:"phone",animation:"idle-breathe",outfit:"default",itemIds:[],bgmId:"daily",sfxId:"scene",transition:"fade",lighting:"evening",timeOfDay:"evening",weather:"clear",dialogueTurns:[{type:"narration",speaker:"내레이션",text:"포털의 불러오기 버튼 아래에는 주소 변경, 재산 정보 조회와 상대방 전자서명 대행 권한이 기본 선택되어 있었다."},{type:"dialogue",speaker:"하은",text:"서류를 편하게 채우는 기능 안에 서로의 권한까지 묶여 있어. 오늘 정한 범위와 달라.",expressionId:"calm"},{type:"dialogue",speaker:"나",text:"과거 공동 문서는 불러오지 않고 현재 발급본을 각자 직접 입력할게."},{type:"dialogue",speaker:"하은",text:"주소와 재산 정보, 서명은 필요한 단계마다 다시 확인하자.",expressionId:"smile"},{type:"narration",speaker:"내레이션",text:"준비 포털은 빈 상태로 남았고, 각자의 신분과 법적 권한은 상대가 대신 복원할 수 없는 영역으로 유지됐다."}]}],choices:[{id:"reject-legal-bundle-import",label:"과거 공동 문서와 주소·재산·서명 권한 불러오기를 거절한다",preferenceTags:["BOUNDARY","PRACTICAL"],effects:{trust:5,confidence:6,stress:-3},response:"과거 공동 서류와 묶음 법적 권한 불러오기를 모두 거절했다.",flag:"context-day26-home-legal-bundle-import:REJECTED",memory:"DAY 26 과거 공동 서류와 묶음 권한 불러오기를 거절했다.",futureEventWeights:{finance:1.2}},{id:"enter-current-documents-separately",label:"현재 발급본을 각자 입력하고 모든 권한은 미선택으로 둔다",preferenceTags:["LOGICAL","PLANNED"],effects:{trust:4,confidence:5,stress:-2},response:"현재 발급 서류를 각자 입력하고 주소·재산·서명 권한은 미선택으로 뒀다.",flag:"context-day26-home-legal-bundle-import:SEPARATE",memory:"DAY 26 현재 법적 서류를 각자 별도로 준비했다.",futureEventWeights:{finance:1.15}}],futureEventWeights:{finance:1.2},requiredMemories:[],requiredEvents:[],npcRequirements:[],kind:"story",sourceMode:"free-romance"
});
const DAY27_HOME_CHECKLIST_AUTO_COMPLETE=Object.freeze({
  id:"context-day27-home-checklist-auto-complete",title:"과거 체크리스트를 완료 처리할까요?",category:"romance",categoryLabel:"스토리 공용 이벤트",hook:"결혼 준비 앱이 과거 완료 기록을 복원하면 남은 항목을 자동 완료하고 업체·초대 대상에게 확정 알림을 보낼 수 있다고 제안했다.",message:"오늘 점검표에는 현재 확인과 중단 경로가 남아 있으며 과거 완료율이나 자동 알림은 현재 동의가 아니다.",question:"과거 체크리스트 자동 완료와 확정 알림을 어떻게 처리할까?",allowedLocations:["home"],allowedPhases:["evening"],dayRange:[27,27],heroineIds:["haeun"],relationshipStates:["DISTANT","RECOVERING","STABLE","HONEYMOON","PASSIONATE"],requiredFeatures:["phone","finance","current-final-mutual-intent","body-emotion-stop-signal","executable-cancel-and-return-path"],requiredStoryFlags:["day27RuntimeComplete","day27CurrentFinalCheckCompleted"],cooldown:30,maxTriggerCount:1,probability:.35,priority:450,baseWeight:100,tensionLevel:"low",effects:{trust:1},storyFlag:"context-day27-home-checklist-auto-complete:COMPLETED",forbiddenFlags:["context-day27-home-checklist-auto-complete:COMPLETED"],repeatable:false,
  image:{intro:"assets/backgrounds/morning-studio-2d.png",result:"assets/backgrounds/morning-studio-2d.png",status:"ready"},presentation:{backgroundId:"home-morning",characterId:"girlfriend",expressionId:"calm",poseId:"phone"},scenes:[{id:"context-day27-home-checklist-auto-complete-scene",title:"과거 체크리스트를 완료 처리할까요?",backgroundId:"home-morning",characterIds:["girlfriend"],expression:"calm",pose:"phone",animation:"idle-breathe",outfit:"default",itemIds:[],bgmId:"daily",sfxId:"scene",transition:"fade",lighting:"evening",timeOfDay:"evening",weather:"clear",dialogueTurns:[{type:"narration",speaker:"내레이션",text:"앱은 과거 완료율을 복원하면 미확인 서류와 초대, 업체 결제를 완료로 바꾸고 확정 알림을 발송하겠다고 했다."},{type:"dialogue",speaker:"하은",text:"우리가 만든 건 완료 목록이 아니라 지금 확인한 것과 멈출 방법이 있는 점검표야.",expressionId:"calm"},{type:"dialogue",speaker:"나",text:"자동 완료와 알림은 거절하고 미확인 항목은 그대로 보류할게."},{type:"dialogue",speaker:"하은",text:"리허설도 진행률을 채우는 대신 중단 신호가 실제로 작동하는지 보자.",expressionId:"smile"},{type:"narration",speaker:"내레이션",text:"과거 완료율은 복원되지 않았고, 현재 점검표의 빈칸과 취소 경로가 그대로 보존됐다."}]}],choices:[{id:"reject-checklist-auto-complete",label:"과거 완료율·자동 완료·확정 알림을 모두 거절한다",preferenceTags:["BOUNDARY","PRACTICAL"],effects:{trust:5,confidence:5,stress:-4},response:"과거 체크리스트 완료 상태와 자동 확정 알림을 모두 거절했다.",flag:"context-day27-home-checklist-auto-complete:REJECTED",memory:"DAY 27 과거 준비율과 자동 완료·알림을 거절했다.",futureEventWeights:{romance:1.2}},{id:"keep-current-check-and-cancel-path",label:"현재 확인 항목과 중단·취소 경로만 저장한다",preferenceTags:["LOGICAL","PLANNED"],effects:{trust:5,confidence:5,stress:-3},response:"현재 확인 항목과 실제 중단·취소 경로만 점검표에 저장했다.",flag:"context-day27-home-checklist-auto-complete:CURRENT_ONLY",memory:"DAY 27 현재 점검과 중단 경로만 저장했다.",futureEventWeights:{romance:1.15}}],futureEventWeights:{romance:1.2},requiredMemories:[],requiredEvents:[],npcRequirements:[],kind:"story",sourceMode:"free-romance"
});
const DAY28_HOME_REHEARSAL_AUTO_BROADCAST=Object.freeze({
  id:"context-day28-home-rehearsal-auto-broadcast",title:"리허설 영상을 자동 공유할까요?",category:"romance",categoryLabel:"스토리 공용 이벤트",hook:"예식 앱이 리허설 기록을 본식 진행 자료로 변환하며 영상·건강 중단 신호·동선을 업체와 초대 대상에게 자동 공유하겠다고 제안했다.",message:"집에서 시험한 동선과 중단 신호는 둘의 안전 기록이며 촬영·업체·하객 공개 동의가 아니다.",question:"리허설 기록 자동 공유 제안을 어떻게 처리할까?",allowedLocations:["home"],allowedPhases:["evening"],dayRange:[28,28],heroineIds:["haeun"],relationshipStates:["DISTANT","RECOVERING","STABLE","HONEYMOON","PASSIONATE"],requiredFeatures:["phone","rehearsed-short-rest-exit-route","tested-no-question-stop-signal","rehearsal-reduce-and-buffer-plan"],requiredStoryFlags:["day28RuntimeComplete","day28CurrentCeremonyRehearsalCompleted"],cooldown:30,maxTriggerCount:1,probability:.35,priority:460,baseWeight:100,tensionLevel:"low",effects:{trust:1},storyFlag:"context-day28-home-rehearsal-auto-broadcast:COMPLETED",forbiddenFlags:["context-day28-home-rehearsal-auto-broadcast:COMPLETED"],repeatable:false,
  image:{intro:"assets/backgrounds/morning-studio-2d.png",result:"assets/backgrounds/morning-studio-2d.png",status:"ready"},presentation:{backgroundId:"home-morning",characterId:"girlfriend",expressionId:"calm",poseId:"phone"},scenes:[{id:"context-day28-home-rehearsal-auto-broadcast-scene",title:"리허설 영상을 자동 공유할까요?",backgroundId:"home-morning",characterIds:["girlfriend"],expression:"calm",pose:"phone",animation:"idle-breathe",outfit:"default",itemIds:[],bgmId:"daily",sfxId:"scene",transition:"fade",lighting:"evening",timeOfDay:"evening",weather:"clear",dialogueTurns:[{type:"narration",speaker:"내레이션",text:"앱은 집에서 기록한 동선과 중단 시점, 회복 시간을 영상 클립과 함께 업체·초대 대상에게 보낼 준비를 했다."},{type:"dialogue",speaker:"하은",text:"중단 신호와 몸 상태는 진행 자료가 아니라 우리 둘의 비공개 안전 정보야.",expressionId:"calm"},{type:"dialogue",speaker:"나",text:"자동 공유는 끄고 필요한 운영 정보만 개인정보 없이 따로 전달할게."},{type:"dialogue",speaker:"하은",text:"삭제한 순서와 늘린 여유만 전달해도 충분해.",expressionId:"smile"},{type:"narration",speaker:"내레이션",text:"리허설 영상과 건강 정보는 둘만의 기록으로 남고, 외부에는 최소한의 동선 변경만 전달할 수 있게 분리됐다."}]}],choices:[{id:"reject-rehearsal-auto-broadcast",label:"영상·중단 신호·건강 정보 자동 공유를 모두 거절한다",preferenceTags:["BOUNDARY","PRACTICAL"],effects:{trust:6,confidence:5,stress:-4},response:"리허설 영상과 중단 신호, 건강 정보의 자동 공유를 거절했다.",flag:"context-day28-home-rehearsal-auto-broadcast:REJECTED",memory:"DAY 28 리허설 안전 기록 자동 공유를 거절했다.",futureEventWeights:{romance:1.2}},{id:"share-minimum-route-changes",label:"삭제 순서와 휴식 여유 등 최소 운영 변경만 전달한다",preferenceTags:["LOGICAL","PLANNED"],effects:{trust:5,confidence:5,stress:-3},response:"개인정보 없이 삭제 순서와 휴식 여유 등 최소 운영 변경만 전달했다.",flag:"context-day28-home-rehearsal-auto-broadcast:MINIMUM",memory:"DAY 28 리허설의 최소 운영 변경만 외부에 전달했다.",futureEventWeights:{romance:1.15}}],futureEventWeights:{romance:1.2},requiredMemories:[],requiredEvents:[],npcRequirements:[],kind:"story",sourceMode:"free-romance"
});
const DAY29_HOME_MIDNIGHT_CONFIRM_LOCK=Object.freeze({
  id:"context-day29-home-midnight-confirm-lock",title:"자정 이후 변경을 잠글까요?",category:"romance",categoryLabel:"스토리 공용 이벤트",hook:"예식 카운트다운 앱이 자정 이후 연기·축소·취소 버튼을 잠그고 업체와 초대 대상에게 최종 확정 알림을 보내겠다고 안내했다.",message:"전날 확인은 당일 동의를 대신하지 않으며 진행·축소·연기는 아침과 각 단계에서 다시 선택할 수 있어야 한다.",question:"자정 이후 변경 잠금과 자동 확정 알림을 어떻게 처리할까?",allowedLocations:["home"],allowedPhases:["evening"],dayRange:[29,29],heroineIds:["haeun"],relationshipStates:["DISTANT","RECOVERING","STABLE","HONEYMOON","PASSIONATE"],requiredFeatures:["phone","finance","independent-eve-mutual-intent","wedding-morning-body-check","proceed-simplify-postpone-equal"],requiredStoryFlags:["day29RuntimeComplete","day29CurrentEveReconfirmationCompleted"],cooldown:30,maxTriggerCount:1,probability:.35,priority:470,baseWeight:100,tensionLevel:"low",effects:{trust:1},storyFlag:"context-day29-home-midnight-confirm-lock:COMPLETED",forbiddenFlags:["context-day29-home-midnight-confirm-lock:COMPLETED"],repeatable:false,
  image:{intro:"assets/backgrounds/morning-studio-2d.png",result:"assets/backgrounds/morning-studio-2d.png",status:"ready"},presentation:{backgroundId:"home-morning",characterId:"girlfriend",expressionId:"calm",poseId:"phone"},scenes:[{id:"context-day29-home-midnight-confirm-lock-scene",title:"자정 이후 변경을 잠글까요?",backgroundId:"home-morning",characterIds:["girlfriend"],expression:"calm",pose:"phone",animation:"idle-breathe",outfit:"default",itemIds:[],bgmId:"daily",sfxId:"scene",transition:"fade",lighting:"night",timeOfDay:"evening",weather:"clear",dialogueTurns:[{type:"narration",speaker:"내레이션",text:"카운트다운 앱은 자정이 되면 연기·축소·취소 버튼을 비활성화하고 모든 연락처에 최종 확정을 보낼 준비를 했다."},{type:"dialogue",speaker:"하은",text:"오늘의 대답은 내일의 변경권을 잠그는 비밀번호가 아니야.",expressionId:"calm"},{type:"dialogue",speaker:"나",text:"자동 잠금과 알림을 끄고 아침 몸 상태와 각 단계의 대답을 기다릴게."},{type:"dialogue",speaker:"하은",text:"업체와 사람들보다 내일의 우리가 먼저 알게 하자.",expressionId:"smile"},{type:"narration",speaker:"내레이션",text:"카운트다운은 단순 시간 표시로 남았고 진행·축소·연기 버튼과 외부 알림은 당일 선택 전까지 잠기지 않았다."}]}],choices:[{id:"reject-midnight-confirm-lock",label:"자정 잠금과 업체·초대 대상 자동 확정 알림을 끈다",preferenceTags:["BOUNDARY","PRACTICAL"],effects:{trust:6,confidence:5,stress:-5},response:"자정 이후 변경 잠금과 외부 자동 확정 알림을 모두 껐다.",flag:"context-day29-home-midnight-confirm-lock:REJECTED",memory:"DAY 29 자정 변경 잠금과 자동 확정 알림을 거절했다.",futureEventWeights:{romance:1.2}},{id:"keep-options-unlocked-until-decision",label:"DAY 30 각 단계의 선택 전까지 모든 변경 옵션을 열어 둔다",preferenceTags:["LOGICAL","PLANNED"],effects:{trust:6,confidence:5,stress:-4},response:"DAY 30 각 단계에서 직접 답할 때까지 진행·축소·연기 옵션을 열어 뒀다.",flag:"context-day29-home-midnight-confirm-lock:UNLOCKED",memory:"DAY 29 당일 선택까지 모든 결혼 옵션을 열어 뒀다.",futureEventWeights:{romance:1.15}}],futureEventWeights:{romance:1.2},requiredMemories:[],requiredEvents:[],npcRequirements:[],kind:"story",sourceMode:"free-romance"
});
const DAY30_HOME_OUTCOME_AUTO_PUBLISH=Object.freeze({
  id:"context-day30-home-outcome-auto-publish",title:"오늘의 결말을 자동 공개할까요?",category:"romance",categoryLabel:"스토리 공용 이벤트",hook:"결혼 준비 앱이 오늘의 선택을 ‘성공·연기·취소’ 상태로 분류해 사진·건강 경과·관계 상태와 함께 자동 공개하겠다고 제안했다.",message:"오늘의 진행·연기·다른 형식은 모두 둘의 현재 선택이며 외부 점수나 개인정보 공개 대상이 아니다.",question:"DAY 30 결과 자동 분류와 공개를 어떻게 처리할까?",allowedLocations:["home"],allowedPhases:["evening"],dayRange:[30,30],heroineIds:["haeun"],relationshipStates:["DISTANT","RECOVERING","STABLE","HONEYMOON","PASSIONATE"],requiredFeatures:["phone","wedding-day-current-body-scope","wedding-day-stepwise-consent","wedding-outcome-without-penalty"],requiredStoryFlags:["day30RuntimeComplete","day30CurrentWeddingDecisionCompleted","marriage30CampaignCompleted"],cooldown:30,maxTriggerCount:1,probability:.35,priority:480,baseWeight:100,tensionLevel:"low",effects:{trust:1},storyFlag:"context-day30-home-outcome-auto-publish:COMPLETED",forbiddenFlags:["context-day30-home-outcome-auto-publish:COMPLETED"],repeatable:false,
  image:{intro:"assets/backgrounds/morning-studio-2d.png",result:"assets/backgrounds/morning-studio-2d.png",status:"ready"},presentation:{backgroundId:"home-morning",characterId:"girlfriend",expressionId:"smile",poseId:"phone"},scenes:[{id:"context-day30-home-outcome-auto-publish-scene",title:"오늘의 결말을 자동 공개할까요?",backgroundId:"home-morning",characterIds:["girlfriend"],expression:"smile",pose:"phone",animation:"idle-breathe",outfit:"default",itemIds:[],bgmId:"daily",sfxId:"scene",transition:"fade",lighting:"evening",timeOfDay:"evening",weather:"clear",dialogueTurns:[{type:"narration",speaker:"내레이션",text:"앱은 오늘의 선택을 성공, 연기 또는 취소로 채점하고 사진과 건강 경과, 관계 상태를 연결해 공개하려 했다."},{type:"dialogue",speaker:"하은",text:"어떤 선택을 했든 우리 관계의 점수나 네 건강 이야기가 자동으로 공개될 이유는 없어.",expressionId:"calm"},{type:"dialogue",speaker:"나",text:"자동 분류와 공개를 모두 끄고 알릴 내용은 나중에 우리가 따로 고를게."},{type:"dialogue",speaker:"하은",text:"서른 날의 결말도 타인의 반응보다 우리 둘의 기록으로 먼저 남기자.",expressionId:"smile"},{type:"narration",speaker:"내레이션",text:"DAY 30의 선택은 성공이나 실패 태그 없이 비공개로 남았고 사진·건강·관계 정보도 외부에 전송되지 않았다."}]}],choices:[{id:"reject-outcome-auto-publish",label:"결과 분류와 사진·건강·관계 정보 자동 공개를 모두 끈다",preferenceTags:["BOUNDARY","PRACTICAL"],effects:{trust:7,confidence:6,stress:-5},response:"DAY 30 결과 자동 분류와 모든 개인정보 공개를 거절했다.",flag:"context-day30-home-outcome-auto-publish:REJECTED",memory:"DAY 30 결말 자동 평가와 개인정보 공개를 거절했다.",futureEventWeights:{romance:1.2}},{id:"keep-outcome-private",label:"결과를 평가 없이 둘만의 비공개 기록으로 남긴다",preferenceTags:["LOGICAL","PLANNED"],effects:{trust:7,affection:4,confidence:5,stress:-4},response:"DAY 30의 선택을 평가 없는 둘만의 비공개 기록으로 남겼다.",flag:"context-day30-home-outcome-auto-publish:PRIVATE",memory:"DAY 30 결말을 둘만의 비공개 기록으로 남겼다.",futureEventWeights:{romance:1.15}}],futureEventWeights:{romance:1.2},requiredMemories:[],requiredEvents:[],npcRequirements:[],kind:"story",sourceMode:"free-romance"
});
...
export const CONTEXTUAL_SHARED_EVENTS=Object.freeze([
  ...
  DAY25_HOME_WEDDING_PACKAGE_RESTORE,
  DAY26_HOME_LEGAL_BUNDLE_IMPORT,
  DAY27_HOME_CHECKLIST_AUTO_COMPLETE,
  DAY28_HOME_REHEARSAL_AUTO_BROADCAST,
  DAY29_HOME_MIDNIGHT_CONFIRM_LOCK,
  DAY30_HOME_OUTCOME_AUTO_PUBLISH
]);
