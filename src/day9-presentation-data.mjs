export const DAY9_REQUIRED_NEW_ASSETS=Object.freeze({});
...
export const DAY9_PRESENTATION_SCENES=Object.freeze({
  ...
  S04_SCOPE_SELECTION:Object.freeze({backgroundId:"office-day",characterId:"female-coworker",supportingCharacterIds:["office-best-male"],expressionId:null,poseId:null,camera:"medium-to-file-close",transition:"cut",bgm:{category:"daily",variant:0,volume:0.055},sfx:["SFX_DOCUMENT_RECEIVE","SFX_PENCIL_NOTE"],assetStatus:"ready"}),
  S05_AUTHORITY_PRESSURE:Object.freeze({backgroundId:"office-day",characterId:"office-rookie",supportingCharacterIds:["office-best-male","female-coworker"],expressionId:null,poseId:null,camera:"tablet-close-to-medium",transition:"cut",bgm:{category:"daily",variant:0,volume:0.05},sfx:["SFX_DOOR_OPEN"],assetStatus:"ready"}),
  S06_BOUNDED_HELP:Object.freeze({backgroundId:"office-day",characterId:"team-lead",supportingCharacterIds:["office-rookie","female-coworker"],expressionId:null,poseId:null,camera:"document-close-to-medium",transition:"crossfade",bgm:{category:"daily",variant:0,volume:0.06},sfx:["SFX_PENCIL_NOTE","SFX_DOCUMENT_RECEIVE"],assetStatus:"ready"}),
...
const READY_BACKGROUNDS=new Set(["home-morning","neighborhood-street-day","office-day"]);
