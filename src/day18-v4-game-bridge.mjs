...
import {getDay18V4PlayableSegment} from './day18-v4-playable-script.mjs?v=30';
...
function presentation(direction) {
  ...
  return {backgroundId, backgroundUrl, characterId,
    characterAssetUrl: characterId === 'girlfriend' ? STORY_OUTFIT_ASSETS.day8 : characterId === 'player-ex' ? NPC_ASSETS['player-ex'] : null,
