...
function buildYunaEvent([slug,title,startDay,endDay,backgroundId,hook,reveal,startExpression,endExpression],index){
  ...
  const eventImage=`assets/events/school-romance/${slug}-01.png`;
