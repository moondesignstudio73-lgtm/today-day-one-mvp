# DAY 1 IMAGE REGENERATION REQUIRED

검사일: 2026-08-26

## 결론

하은 포즈 9종(약 997–1024 × 1535–1577), 병원 배경·CG(1672 × 941)는 현재 최대 표시 크기를 감당한다. 반면 의료진 6종은 높이가 503–512px에 불과해 1366×768 실제 플레이에서도 약 400–470px로 표시되며, 최대 표시 높이의 1.5배 원본 기준을 충족하지 못한다. 의료진은 모두 **C — 재생성 권장**이다.

기존 파일은 DAY 1 기능 보호를 위해 임시 유지한다. 2026-08-26 고해상도 의사 재생성 시도는 1024×1536 24bpp RGB 체크무늬 배경으로 출력되어 프로젝트에 반영하지 않았다.
